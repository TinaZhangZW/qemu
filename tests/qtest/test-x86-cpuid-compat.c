...
static const CpuidTestArgs cpuid_tests[] = {
    ...
    },
    {
        ...
        "Dhyana", "x-vendor-cpu-abi-compat=off", NULL,
...
static const FeatureTestArgs feature_tests[] = {
    ...
    },
    {
        ...
        "Dhyana", "x-vendor-cpu-abi-compat=off",
...
static const BoolPropTestArgs bool_prop_tests[] = {
    {
        "x86/cpuid/props/dhyana/vendor-cpu-abi-compat/default",
        "Dhyana", NULL, NULL, "x-vendor-cpu-abi-compat", true,
    },
    {
        "x86/cpuid/props/dhyana/vendor-cpu-abi-compat/pc-i440fx-11.0",
        "Dhyana", NULL, "pc-i440fx-11.0",
        "x-vendor-cpu-abi-compat", false,
    },
};
